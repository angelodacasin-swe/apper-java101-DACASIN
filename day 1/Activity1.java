...
class FlamesHope {
    ...
    public static void main(String[] args) {
        ...
        // If empty, display "Your name is required." then the program should terminate.
        return;
        ...
        // Check if crush name is not empty
        if(crushName.isEmpty()) {
            System.out.println("Your crushName is required.");
        
        // If empty, display "Your crushName is required." then the progran should terminate
        return;
        ...
        int result = result(nameLength, crushNameLength); // This will call result method with nameLength and crushNameLength
        ...
        // Check if result is less than 50, display "SAD :( ", else display name and crush name with <3. Use "Angelo and Myself is <3"
        if (result < 50) {
